...
const footerLinks = {
  ...
  capabilities: [
    { name: "Generative AI", href: "/services#ai" },
    { name: "Predictive Analytics", href: "/services#analytics" },
    { name: "MLOps", href: "/services#mlops" },
    { name: "Document Intelligence", href: "/services#documents" },
  ],
};
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-display font-bold">Brainyworks</span>
            </Link>
            <p className="text-muted-foreground max-w-sm mb-6">
              We build AI automation and software that ships—production-ready, secure, and scalable.
            </p>
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/brainyworks"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-secondary/80 transition-colors"
                aria-label="GitHub"
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Brainyworks. All rights reserved.
          </p>
